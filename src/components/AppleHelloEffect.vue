<template>
  <svg
    :class="['apple-hello-svg', className]"
  ...
  >
    ...
    <path
      ...
      :style="{ animationDuration: calc(0.8) + 's' }"
    />
    <!-- h2, ello -->
    <path
      class="hello-path ello-path"
      ...
      style="stroke-linecap: round;"
      :style="{ animationDuration: calc(2.8) + 's', animationDelay: calc(0.7) + 's' }"
      @animationend="handleAnimationComplete"
    />
  </svg>
</template>
