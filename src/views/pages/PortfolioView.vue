    ...
    <section class="portfolio section" id="portfolio">
        ...
        <div class="portofolio__container container">
            <div class="swipe-deck">
                ...
                >
                    <img :src="card.image" :alt="card.title" class="swipe-card__img" draggable="false">

                    <div class="swipe-card__data" :style="{ pointerEvents: dragging ? 'none' : 'auto' }">
                    ...
                    <div v-if="stackIndex === 0" class="swipe-card__stamp swipe-card__stamp--next" :style="{ opacity: nextOpacity }">NEXT</div>
                    <div v-if="stackIndex === 0" class="swipe-card__stamp swipe-card__stamp--back" :style="{ opacity: backOpacity }">BACK</div>
                </div>
            </div>
        </div>

        <div class="swipe-controls">
            <button type="button" class="swipe-btn" aria-label="Previous project" @click="triggerThrow('right')">
                <i class="uil uil-angle-left-b swiper-portofolio-icon"></i>
            </button>

            <div class="swipe-dots">
                <span v-for="(item, i) in portfolio.items" :key="i" class="swipe-dot"
                    :class="{ 'swipe-dot--active': i === activeIndex }"></span>
            </div>

            <button type="button" class="swipe-btn" aria-label="Next project" @click="triggerThrow('left')">
...
export default {
    ...
    methods: {
        cardStyle(stackIndex) {
            if (stackIndex === 0) {
                let dx = 0, dy = 0, rotate = 0, opacity = 1, transition = 'none'
                if (this.throwing) {
